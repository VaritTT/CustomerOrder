...
<body>
    ...
    <div class="col-12 mt-5 mb-4 text-center">
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            ...
            <a href="report_order_unpaid.php" class="btn btn-outline-info active">ยังไม่ได้ชำระ</a>
    ...
    <div class="d-flex justify-content-between mt-4">
        <div class="d-flex">
            <h4 style="font-weight: 600;">รายงานการสั่งซื้อ(ที่ยังไม่ได้ชำระ) <?php echo $periods_name; ?> <span class="badge text-bg-secondary"><?php echo $row_count . "/" . $order2; ?></span></h4>
                ...
                ?>
                    <tr>
                        ...
                        <td class="col-3 text-center" style="vertical-align: middle;">
                            ...
                            <a href="controller/update_order.php?id=<?= $row['order_id'] ?>" class="btn btn-success" onclick="upd(this.href); return false;">ชำระเงินแล้ว</a>
                            <a href="controller/cancel_order.php?id=<?= $row['order_id'] ?>" class="btn btn-danger" onclick="del(this.href); return false;">ยกเลิก</a>
                        </td>
                    </tr>
