...
<body>
    ...
    <div class="col-12 mt-5 mb-4 text-center">
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            ...
            <a href="report_order_cancel.php" class="btn btn-outline-info active">ยกเลิกการซื้อ</a>
        </div>
    </div>

    <div class="d-flex justify-content-between mt-4">
        <div class="d-flex">
            <h4 style="font-weight: 600;">รายงานการสั่งซื้อ(ที่ถูกยกเลิก) <?php echo $periods_name; ?> <span class="badge text-bg-danger"><?php echo $row_count . "/" . $order3; ?></span></h4>
